...
import bcgov.jh.etk.jhetkcommon.dataaccess.rowmapper.TicketRecordMapper;
import bcgov.jh.etk.jhetkcommon.dataaccess.storedprocedure.StoredProcedureBase;

/**
 * The Class GetTicketsSentTodayStoredProc.
 * @author eliang
 */
@Service
public class GetTicketsReceivedTodayStoredProc extends StoredProcedureBase {
	/** The Constant NAME_STORE_PROCEDURE. */
	private static final String NAME_STORE_PROCEDURE = "jh_etk_get_tickets_received_today";
	...
	protected SqlParameter[] getParameters() {
		SqlOutParameter pOut = new SqlOutParameter(PARAM_OUT_P_RECORDS, Types.REF_CURSOR, new TicketRecordMapper());
