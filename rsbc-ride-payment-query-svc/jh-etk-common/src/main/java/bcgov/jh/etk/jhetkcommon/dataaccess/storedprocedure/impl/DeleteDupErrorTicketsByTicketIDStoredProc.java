...
@Service
public class DeleteDupErrorTicketsByTicketIDStoredProc extends StoredProcedureBase {
	/** The Constant NAME_STORE_PROCEDURE. */
	private static final String NAME_STORE_PROCEDURE = "jh_etk_delete_duperror_tickets_by_ticket_id";
