...
/**
 * The Class GetNextQueuedDisputeRecordStoredProc.
 */
@Service
public class GetNextQueuedDisputeRecordStoredProc extends StoredProcedureBase {
	/** The Constant NAME_STORE_PROCEDURE. */
	private static final String NAME_STORE_PROCEDURE = "jh_etk_get_next_queued_dispute";
	...
	protected SqlParameter[] getParameters() {
		...
		SqlParameter[] paramArray = {p_data_type_cd, pOut};
		return paramArray;
	}
